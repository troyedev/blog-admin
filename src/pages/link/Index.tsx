...
import { deleteLink, getLinkList } from "../../services/link";
...
export default function LinkManage() {
  ...
  const [curRecord, setCurRecord] = useState<Link>();
  const [openEdit, setOpenEdit] = useState(false);

  const { data, isLoading, refetch } = useQuery({
    queryKey: [getLinkList.name, pageNum, pageSize, where],
    queryFn: () =>
      getLinkList({
        page_num: pageNum,
        page_size: pageSize,
